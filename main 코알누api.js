...
const getLatestNews = async ()=>{
    ...
    const url = new URL(`http://times-node-env.eba-appvq3ef.ap-northeast-2.elasticbeanstalk.com/top-headlines`); // 인스턴스 : url에 필요한 함수와 변수들을 제공함. || 'URL'이라는 새로운 인스턴스(new)를 만들어준다. : new URL() || URL의 주소는 https://newsapi.org/v2/top-headlines?country=us&apiKey=${API_KEY}를 통해 생성이 된다.
    //console.log('uuu',url);
